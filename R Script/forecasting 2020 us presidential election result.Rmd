...
Table 3 shows the proportion of people voting for Trump of Biden. We here grouped the model by the variable *employment*, which has divisions **employment, not in labor force, and unemployed*, the answers as *n/a* have luckly been filtered out when we filter the census data of people over 18 years old. 
The table shows that out of all employed people, 0.40 or 40% of them vote for Trump and 0.417 or 41.7% vote for Biden, and the other divisions are shown in Graph 1 (Bar plot for Employment and Vote Intention). Out of all people not in labor force, 0.377 vote for Trump and 0.429 vote for Biden. Lastly out of all unemployed, 0.314 vote for Trump and 0.411 vote for Biden.
In Graph 1, the bar plot separates each proportion by numbers and the index is on the right side. Showing the porportion of people voting for Trump and Biden are about the same, with small porportions saying *I am not sure/don't know*, *I would not vote* and *someone else*. Same applies for the *not in labor force* and *unemployed* group, the proportions voting for the two are visually similar, with small proportions of people saying others.
...
Table 4 shows the percentage/proportion of people voting for Trump or Biden within the gender groups. The bar plot of the percentages are shown in Graph 2 (Bar plot for Gender and Vote Intention). It is summarized in the table below, out of all females, 0.32 (or 32%) vote for Trump and 0.46 vote for Biden. Within the males, 0.45 vote for Trump and 0.38 vote for Biden.
